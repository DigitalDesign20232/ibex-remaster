...
## Clock signal #
set_property -dict {PACKAGE_PIN F23 IOSTANDARD LVCMOS18} [get_ports IO_CLK]
...
## Switches #
set_property -dict {PACKAGE_PIN E4 IOSTANDARD LVCMOS18} [get_ports {SW[0]}]
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS18} [get_ports {SW[1]}]
set_property -dict {PACKAGE_PIN F5 IOSTANDARD LVCMOS18} [get_ports {SW[2]}]
set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS18} [get_ports {SW[3]}]
...
## LEDs #
set_property -dict {PACKAGE_PIN D5 IOSTANDARD LVCMOS18} [get_ports {LED[0]}]
set_property -dict {PACKAGE_PIN D6 IOSTANDARD LVCMOS18} [get_ports {LED[1]}]
set_property -dict {PACKAGE_PIN A5 IOSTANDARD LVCMOS18} [get_ports {LED[2]}]
set_property -dict {PACKAGE_PIN B5 IOSTANDARD LVCMOS18} [get_ports {LED[3]}]

## Buttons #
set_property -dict {PACKAGE_PIN B4 IOSTANDARD LVCMOS18} [get_ports {BTN[0]}]
set_property -dict {PACKAGE_PIN C4 IOSTANDARD LVCMOS18} [get_ports {BTN[1]}]
set_property -dict {PACKAGE_PIN B3 IOSTANDARD LVCMOS18} [get_ports {BTN[2]}]
set_property -dict {PACKAGE_PIN C3 IOSTANDARD LVCMOS18} [get_ports {BTN[3]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports IO_RST_N]
set_property IOSTANDARD LVCMOS18 [get_ports SPI_RX]
set_property IOSTANDARD LVCMOS18 [get_ports SPI_SCK]
set_property IOSTANDARD LVCMOS18 [get_ports SPI_TX]
set_property IOSTANDARD LVCMOS18 [get_ports {DISP_CTRL[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DISP_CTRL[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DISP_CTRL[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DISP_CTRL[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[11]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[10]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[9]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[8]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[7]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[6]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[5]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {RGB_LED[0]}]
set_property PACKAGE_PIN A2 [get_ports {DISP_CTRL[3]}]
set_property PACKAGE_PIN A3 [get_ports {DISP_CTRL[2]}]
set_property PACKAGE_PIN A6 [get_ports {DISP_CTRL[1]}]
set_property PACKAGE_PIN A7 [get_ports {DISP_CTRL[0]}]
set_property PACKAGE_PIN A8 [get_ports {RGB_LED[11]}]
set_property PACKAGE_PIN A9 [get_ports {RGB_LED[10]}]
set_property PACKAGE_PIN A10 [get_ports {RGB_LED[9]}]
set_property PACKAGE_PIN A11 [get_ports {RGB_LED[8]}]
set_property PACKAGE_PIN A12 [get_ports {RGB_LED[7]}]
set_property PACKAGE_PIN A13 [get_ports {RGB_LED[6]}]
set_property PACKAGE_PIN A14 [get_ports {RGB_LED[5]}]
set_property PACKAGE_PIN A15 [get_ports {RGB_LED[4]}]
set_property PACKAGE_PIN A16 [get_ports {RGB_LED[3]}]
set_property PACKAGE_PIN A17 [get_ports {RGB_LED[2]}]
set_property PACKAGE_PIN A18 [get_ports {RGB_LED[1]}]
set_property PACKAGE_PIN A19 [get_ports {RGB_LED[0]}]
set_property PACKAGE_PIN A22 [get_ports IO_RST_N]
set_property PACKAGE_PIN A23 [get_ports SPI_RX]
set_property PACKAGE_PIN AA14 [get_ports SPI_SCK]
set_property PACKAGE_PIN AA15 [get_ports SPI_TX]
